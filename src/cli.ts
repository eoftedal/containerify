...
const possibleArgs = {
	"--from <registry/image:tag>": "Shorthand to specify fromRegistry and fromImage in one argument",
	"--to <registry/image:tag>": "Shorthand to specify toRegistry and toImage in one argument",
